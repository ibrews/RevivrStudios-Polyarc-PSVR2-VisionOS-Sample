...
class ANDROIDXREDITOR_API IAndroidXREditorModule : public IModuleInterface
{
public:
    /**
     ...
     */
    static inline IAndroidXREditorModule& Get()
    {
        return FModuleManager::LoadModuleChecked<IAndroidXREditorModule>("AndroidXREditor");
    }
    ...
    {
        return FModuleManager::Get().IsModuleLoaded("AndroidXREditor");
    }
};
