...
#include "AndroidXREventProxy.generated.h"

UCLASS(NotBlueprintable)
class ANDROIDXR_API UAndroidXREventProxy : public UObject
{
    GENERATED_BODY()
public:
    UPROPERTY(BlueprintAssignable, Category="AndroidXR Event")
    FAndroidXRPerfSettingsDynamicDelegate OnPerfSettingsDelegate;
